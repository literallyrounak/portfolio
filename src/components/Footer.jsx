      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            <h2 className="footer-logo">Rounak</h2>
          </div>
          ...
          <div className="footer-social-icons">
            ...
            <a href="https://bsky.app/profile/literallyrounak.bsky.social" target="_blank" rel="noopener noreferrer" className="footer-icon-link"><Globe size={20} /></a>
            <a href="mailto:kumarguptarounak7@gmail.com" className="footer-icon-link"><Mail size={20} /></a>
          </div>
